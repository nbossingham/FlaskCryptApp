...
def messageSent(msg):
    ...
    encrPrintData=f"<b>Private Key:</b> <textarea readonly=\"True\" cols=\"50\">{userPrivate}</textarea><br> <b>IV:</b> <textarea readonly=\"True\" cols=\"50\">{userIV}</textarea><br> <b>Padded Text:(Padding does not always show) </b> <div height: 390px; overflow-y: scroll;><p columns=\"50\">{paddedText}</p></div><br> <b>Cipher Text:</b> <textarea readonly=\"True\" cols=\"50\">{encrMsg}</textarea>"
    decrPrintData=f"<b>Private Key:</b> <textarea readonly=\"True\" cols=\"50\">{botPrivate}</textarea><br> <b>IV:</b> <textarea readonly=\"True\" cols=\"50\">{botIV}</textarea><br> <b>Padded Text: (Padding does not always show) </b> <div height: 390px; overflow-y: scroll;><p columns=\"50\">{paddedUnenc}</p></div><br> <b>Decrypted Text:</b> <textarea readonly=\"True\" cols=\"50\">{decrMsg}</textarea>"
