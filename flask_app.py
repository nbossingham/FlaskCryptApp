...
def messageSent(msg):
    ...
    encrPrintData=f"<b>Private Key:</b> <textarea readonly=\"True\" cols=\"50\">{userPrivate}</textarea><br> <b>IV:</b> <textarea readonly=\"True\" cols=\"50\">{userIV}</textarea><br> <b>Padded Text:</b> <p cols=\"50\">{paddedText}</p><br> <b>Cipher Text:</b> <textarea readonly=\"True\" cols=\"50\">{encrMsg}</textarea>"
    decrPrintData=f"<b>Private Key:</b> <textarea readonly=\"True\" cols=\"50\">{botPrivate}</textarea><br> <b>IV:</b> <textarea readonly=\"True\" cols=\"50\">{botIV}</textarea><br> <b>Padded Text:</b> <p cols=\"50\">{paddedUnenc}</p><br> <b>Decrypted Text:</b> <textarea readonly=\"True\" cols=\"50\">{decrMsg}</textarea>"
